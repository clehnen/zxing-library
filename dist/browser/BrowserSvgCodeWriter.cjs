...
class BrowserSvgCodeWriter {
  ...
  write(contents, width, height, hints = null) {
    ...
    let quietZone = hints && hints.get(EncodeHintType.EncodeHintType.MARGIN) !== void 0 ? Number.parseInt(hints.get(EncodeHintType.EncodeHintType.MARGIN).toString(), 10) : BrowserSvgCodeWriter.QUIET_ZONE_SIZE;
  ...
  encode(hints, contents) {
    ...
    if (hints && hints.get(EncodeHintType.EncodeHintType.ERROR_CORRECTION) !== void 0) {
...
//# sourceMappingURL=BrowserSvgCodeWriter.cjs.map
//# sourceMappingURL=BrowserSvgCodeWriter.cjs.map