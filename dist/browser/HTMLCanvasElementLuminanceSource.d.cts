import { LuminanceSource } from '../core/LuminanceSource.cjs';

/**
 * @deprecated Moving to @zxing/browser
 */
declare class HTMLCanvasElementLuminanceSource extends LuminanceSource {
    private canvas;
    private buffer;
    private static DEGREE_TO_RADIANS;
    private static FRAME_INDEX;
    private tempCanvasElement;
    constructor(canvas: HTMLCanvasElement, doAutoInvert?: boolean, reuseBuffer?: Uint8ClampedArray);
