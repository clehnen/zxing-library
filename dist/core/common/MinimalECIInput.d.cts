...
import { ECIEncoderSet } from './ECIEncoderSet.cjs';
import { ZXingCharset } from '../util/ZXingCharset.cjs';
import { ECIInput } from './ECIInput.cjs';
import './CharacterSetECI.cjs';

declare class MinimalECIInput implements ECIInput {
    private bytes;
    private fnc1;
    /**
