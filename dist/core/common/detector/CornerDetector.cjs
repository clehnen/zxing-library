...
class CornerDetector {
  ...
  findCorners(right, left, down, up) {
    ...
    const a = new ResultPoint.ResultPoint(left - deltaX, up - deltaY);
    const b = new ResultPoint.ResultPoint(right + deltaX, up - deltaY);
    const c = new ResultPoint.ResultPoint(right + deltaX, down + deltaY);
    const d = new ResultPoint.ResultPoint(left - deltaX, down + deltaY);
    const ap = new ResultPoint.ResultPoint(a.getX() + areaWidth, a.getY() + areaHeight);
    const bp = new ResultPoint.ResultPoint(b.getX() - areaWidth, b.getY() + areaHeight);
    const cp = new ResultPoint.ResultPoint(c.getX() - areaWidth, c.getY() - areaHeight);
    const dp = new ResultPoint.ResultPoint(d.getX() + areaWidth, d.getY() - areaHeight);
    ...
    const topLeftCornerCenter = new ResultPoint.ResultPoint(topLeftCorner.getX() + xCorrection, topLeftCorner.getY() + yCorrection);
    const topRightCornerCenter = new ResultPoint.ResultPoint(topRightCorner.getX() - xCorrection, topRightCorner.getY() + yCorrection);
    const bottomRightCornerCenter = new ResultPoint.ResultPoint(bottomRightCorner.getX() - xCorrection, bottomRightCorner.getY() - yCorrection);
    const bottomLeftCornerCenter = new ResultPoint.ResultPoint(bottomLeftCorner.getX() + xCorrection, bottomLeftCorner.getY() - yCorrection);
  ...
  getCornerFromArea(left, right, top, bottom, maximizeX, maximizeY) {
    ...
    if (resX === 0 || resY === 0) {
      ...
      return new ResultPoint.ResultPoint(resX, resY);
    }
  }
  /**
...
exports.CornerDetector = CornerDetector;
//# sourceMappingURL=CornerDetector.cjs.map
//# sourceMappingURL=CornerDetector.cjs.map