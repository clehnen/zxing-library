...
class MinimalECIInput {
  ...
  constructor(stringToEncode, priorityCharset, fnc1) {
    this.fnc1 = fnc1;
    const encoderSet = new ECIEncoderSet.ECIEncoderSet(stringToEncode, priorityCharset, fnc1);
...
//# sourceMappingURL=MinimalECIInput.cjs.map
//# sourceMappingURL=MinimalECIInput.cjs.map