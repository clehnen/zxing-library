...
var CharacterSetValueIdentifiers = /* @__PURE__ */ ((CharacterSetValueIdentifiers2) => {
  ...
  return CharacterSetValueIdentifiers2;
...
class CharacterSetECI {
  ...
  valueIdentifier;
  name;
  static VALUE_IDENTIFIER_TO_ECI = /* @__PURE__ */ new Map();
  static VALUES_TO_ECI = /* @__PURE__ */ new Map();
  static NAME_TO_ECI = /* @__PURE__ */ new Map();
  // Enum name is a Java encoding valid for java.lang and java.io
  // TYPESCRIPTPORT: changed the main label for ISO as the TextEncoder did not recognized them in the form from java
  // (eg ISO8859_1 must be ISO88591 or ISO8859-1 or ISO-8859-1)
  // later on: well, except 16 wich does not work with ISO885916 so used ISO-8859-1 form for default
  static Cp437 = new CharacterSetECI(
    0 /* Cp437 */,
    Int32Array.from([0, 2]),
    "Cp437"
  );
  ...
  static SJIS = new CharacterSetECI(
    16 /* SJIS */,
    20,
    "SJIS",
    "Shift_JIS"
  );
  static Cp1250 = new CharacterSetECI(
    17 /* Cp1250 */,
    21,
    "Cp1250",
    "windows-1250"
  );
  static Cp1251 = new CharacterSetECI(
    18 /* Cp1251 */,
    22,
    "Cp1251",
    "windows-1251"
  );
  static Cp1252 = new CharacterSetECI(
    19 /* Cp1252 */,
    23,
    "Cp1252",
    "windows-1252"
  );
  static Cp1256 = new CharacterSetECI(
    20 /* Cp1256 */,
    24,
    "Cp1256",
    "windows-1256"
  ...
  static UnicodeBigUnmarked = new CharacterSetECI(
    21 /* UnicodeBigUnmarked */,
    25,
    "UnicodeBigUnmarked",
    "UTF-16BE",
    "UnicodeBig"
  );
  static UTF8 = new CharacterSetECI(
    22 /* UTF8 */,
    26,
    "UTF8",
    "UTF-8"
  ...
  static Big5 = new CharacterSetECI(
    24 /* Big5 */,
    28,
    "Big5"
  );
  static GB18030 = new CharacterSetECI(
    25 /* GB18030 */,
    29,
    "GB18030",
    "GB2312",
  ...
  static EUC_KR = new CharacterSetECI(
    26 /* EUC_KR */,
    30,
    "EUC_KR",
    "EUC-KR"
  ...
  static getCharacterSetECIByValue(value) {
    if (value < 0 || value >= 900) {
      throw new FormatException.FormatException("incorect value");
    }
...
exports.CharacterSetValueIdentifiers = CharacterSetValueIdentifiers;
//# sourceMappingURL=CharacterSetECI.cjs.map
//# sourceMappingURL=CharacterSetECI.cjs.map