...
class AbstractRSSReader extends OneDReader.OneDReader {
  static MAX_AVG_VARIANCE = 0.2;
  static MAX_INDIVIDUAL_VARIANCE = 0.45;
  /** Minimum ratio 10:12 (minus 0.5 for variance), from section 7.2.7 of ISO/IEC 24724:2006. */
  static MIN_FINDER_PATTERN_RATIO = 9.5 / 12;
  /** Maximum ratio 12:14 (plus 0.5 for variance), from section 7.2.7 of ISO/IEC 24724:2006. */
  static MAX_FINDER_PATTERN_RATIO = 12.5 / 14;
  ...
  parseFinderValue(counters, finderPatterns) {
    for (let value = 0; value < finderPatterns.length; value++) {
      if (OneDReader.OneDReader.patternMatchVariance(counters, finderPatterns[value], AbstractRSSReader.MAX_INDIVIDUAL_VARIANCE) < AbstractRSSReader.MAX_AVG_VARIANCE) {
        return value;
      }
    }
   ...
   */
  static count(array) {
    return MathUtils.MathUtils.sum(new Int32Array(array));
  }
...
exports.AbstractRSSReader = AbstractRSSReader;
//# sourceMappingURL=AbstractRSSReader.cjs.map
//# sourceMappingURL=AbstractRSSReader.cjs.map