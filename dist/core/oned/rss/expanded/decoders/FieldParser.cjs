...
class FieldParser {
  ...
  static TWO_DIGIT_DATA_LENGTH = (() => {
    ...
    out.set("22", FieldParser.variable(2, 29));
  ...
  static THREE_DIGIT_DATA_LENGTH = /* @__PURE__ */ new Map([
  ...
  static THREE_DIGIT_PLUS_DIGIT_DATA_LENGTH = (() => {
    const out = /* @__PURE__ */ new Map();
  ...
  static FOUR_DIGIT_DATA_LENGTH = (() => {
    ...
    out.set("8100", FieldParser.fixed(4, 6));
    out.set("8101", FieldParser.fixed(4, 10));
    out.set("8102", FieldParser.fixed(4, 2));
...
//# sourceMappingURL=FieldParser.cjs.map
//# sourceMappingURL=FieldParser.cjs.map