...
class Code128Reader extends OneDReader.OneDReader {
      ...
      if (row.get(i) !== isWhite) {
        ...
        if (counterPosition === patternLength - 1) {
          ...
          for (let startCode = Code128Reader.CODE_START_A; startCode <= Code128Reader.CODE_START_C; startCode++) {
            const variance = OneDReader.OneDReader.patternMatchVariance(
              counters,
  ...
  static decodeCode(row, counters, rowOffset) {
    OneDReader.OneDReader.recordPattern(row, rowOffset, counters);
    let bestVariance = Code128Reader.MAX_AVG_VARIANCE;
    let bestMatch = -1;
  ...
  decodeRow(rowNumber, row, hints) {
    const convertFNC1 = hints && hints.get(DecodeHintType.DecodeHintType.ASSUME_GS1) === true;
    ...
    const points = [new ResultPoint.ResultPoint(left, rowNumber), new ResultPoint.ResultPoint(right, rowNumber)];
    return new Result.Result(result, rawBytes, 0, points, BarcodeFormat.BarcodeFormat.CODE_128, (/* @__PURE__ */ new Date()).getTime());
  }
}

exports.Code128Reader = Code128Reader;
//# sourceMappingURL=Code128Reader.cjs.map
//# sourceMappingURL=Code128Reader.cjs.map