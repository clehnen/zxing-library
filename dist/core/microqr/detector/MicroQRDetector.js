...
class MicroQRDetector {
  ...
  resultPointCallback;
  detect(hints) {
    this.resultPointCallback = hints != null ? hints.get(DecodeHintType.NEED_RESULT_POINT_CALLBACK) ?? null : null;
  ...
  findFinderPattern(hints) {
    ...
    const tryHarder = hints != null && hints.get(DecodeHintType.TRY_HARDER) !== void 0;
...
export { MicroQRDetector };
//# sourceMappingURL=MicroQRDetector.js.map
//# sourceMappingURL=MicroQRDetector.js.map