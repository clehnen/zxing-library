...
declare class MicroQRFormatInformation {
     ...
     */
    static decodeFormatInformation(maskedFormatInfo: number): MicroQRFormatInformation | null;
    /**
     ...
     */
    getMicroQRVersionNumber(): number;
