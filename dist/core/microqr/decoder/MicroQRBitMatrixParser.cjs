...
var MicroQRFormatInformation = require('./MicroQRFormatInformation');
var MicroQRVersion = require('./MicroQRVersion');
var MicroQRDataMask = require('./MicroQRDataMask');
...
class MicroQRBitMatrixParser {
  ...
  readFormatInformation() {
    ...
    const formatInfo = MicroQRFormatInformation.MicroQRFormatInformation.decodeFormatInformation(formatInfoBits);
    if (formatInfo !== null) {
      this.parsedFormatInfo = formatInfo;
      this.parsedVersion = MicroQRVersion.MicroQRVersion.getVersionForIndicator(formatInfo.getVersionIndicator());
      return formatInfo;
    }
    throw new FormatException.FormatException();
  }
  ...
  readCodewords() {
    ...
    const dataMask = MicroQRDataMask.MicroQRDataMask.forIndex(formatInfo.getDataMask());
...
exports.MicroQRBitMatrixParser = MicroQRBitMatrixParser;
//# sourceMappingURL=MicroQRBitMatrixParser.cjs.map
//# sourceMappingURL=MicroQRBitMatrixParser.cjs.map