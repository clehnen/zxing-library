 ...
 */
declare class MicroQRDataMask {
    private readonly maskIndex;
    private readonly isMasked;
    private constructor();
    private static readonly MASKS;
    static forIndex(maskIndex: number): MicroQRDataMask;
    /**
