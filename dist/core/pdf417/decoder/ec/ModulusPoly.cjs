...
class ModulusPoly {
  ...
  add(other) {
    if (!this.field.equals(other.field)) {
      throw new IllegalArgumentException.IllegalArgumentException("ModulusPolys do not have same ModulusGF field");
    }
    if (this.isZero()) {
      return other;
    }
...
exports.ModulusPoly = ModulusPoly;
//# sourceMappingURL=ModulusPoly.cjs.map
//# sourceMappingURL=ModulusPoly.cjs.map