...
var ModulusGF = require('./ModulusGF');
...
class PDF417DecoderErrorCorrection {
  ...
  decode(received, numECCodewords, erasures) {
    let poly = new ModulusPoly.ModulusPoly(this.field, received);
    ...
    if (erasures != null) {
      for (const erasure of erasures) {
        ...
        let term = new ModulusPoly.ModulusPoly(this.field, new Int32Array([this.field.subtract(0, b), 1]));
        knownErrors = knownErrors.multiply(term);
      }
    }
    let syndrome = new ModulusPoly.ModulusPoly(this.field, S);
  ...
  findErrorMagnitudes(errorEvaluator, errorLocator, errorLocations) {
    ...
    let formalDerivative = new ModulusPoly.ModulusPoly(this.field, formalDerivativeCoefficients);
...
exports.PDF417DecoderErrorCorrection = PDF417DecoderErrorCorrection;
//# sourceMappingURL=PDF417DecoderErrorCorrection.cjs.map
//# sourceMappingURL=PDF417DecoderErrorCorrection.cjs.map