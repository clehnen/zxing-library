...
import { PDF417DecoderErrorCorrection } from './ec/PDF417DecoderErrorCorrection.cjs';
import { BarcodeValue } from './BarcodeValue.cjs';
 ...
 */
declare class PDF417ScanningDecoder {
    static CODEWORD_SKEW_SIZE: int;
    static MAX_ERRORS: int;
    static MAX_EC_CODEWORDS: int;
    static errorCorrection: PDF417DecoderErrorCorrection;
    private constructor();
    /**
