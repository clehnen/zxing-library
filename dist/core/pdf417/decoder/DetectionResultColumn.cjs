...
class DetectionResultColumn {
  static MAX_NEARBY_DISTANCE = 5;
  boundingBox;
  codewords;
  constructor(boundingBox) {
    this.boundingBox = new BoundingBox.BoundingBox(boundingBox);
  ...
  // @Override
  toString() {
    const formatter = new Formatter.Formatter();
    let row = 0;
...
exports.DetectionResultColumn = DetectionResultColumn;
//# sourceMappingURL=DetectionResultColumn.cjs.map
//# sourceMappingURL=DetectionResultColumn.cjs.map