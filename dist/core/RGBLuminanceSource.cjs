...
class RGBLuminanceSource extends LuminanceSource.LuminanceSource {
  ...
  getRow(y, row) {
    ...
    ZXingSystem.ZXingSystem.arraycopy(this.luminances, offset, row, 0, width);
    return row;
  }
  /*@Override*/
  getMatrix() {
    ...
    if (width === this.dataWidth) {
      ZXingSystem.ZXingSystem.arraycopy(this.luminances, inputOffset, matrix, 0, area);
      return matrix;
    }
    for (let y = 0; y < height; y++) {
      const outputOffset = y * width;
      ZXingSystem.ZXingSystem.arraycopy(this.luminances, inputOffset, matrix, outputOffset, width);
...
//# sourceMappingURL=RGBLuminanceSource.cjs.map
//# sourceMappingURL=RGBLuminanceSource.cjs.map