...
var MaxiCodeDecodedBitStreamParser = require('./MaxiCodeDecodedBitStreamParser');
...
class MaxiCodeDecoder {
  ...
  rsDecoder;
  constructor() {
    this.rsDecoder = new ReedSolomonDecoder.ReedSolomonDecoder(GenericGF.GenericGF.MAXICODE_FIELD_64);
  }
  decode(bits, hints) {
    ...
    const result = MaxiCodeDecodedBitStreamParser.MaxiCodeDecodedBitStreamParser.decode(datawords, mode);
  ...
  correctErrors(codewordBytes, start, dataCodewords, ecCodewords, mode) {
    ...
    try {
      ...
      if (ex instanceof ReedSolomonException.ReedSolomonException) {
...
exports.MaxiCodeDecoder = MaxiCodeDecoder;
//# sourceMappingURL=MaxiCodeDecoder.cjs.map
//# sourceMappingURL=MaxiCodeDecoder.cjs.map