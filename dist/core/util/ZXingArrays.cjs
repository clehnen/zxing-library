...
var ArrayIndexOutOfBoundsException = require('../ArrayIndexOutOfBoundsException');
...
class ZXingArrays {
  ...
  static fillWithin(a, fromIndex, toIndex, val) {
    ZXingArrays.rangeCheck(a.length, fromIndex, toIndex);
  ...
  static rangeCheck(arrayLength, fromIndex, toIndex) {
    ...
    if (fromIndex < 0) {
      throw new ArrayIndexOutOfBoundsException.ArrayIndexOutOfBoundsException(fromIndex);
    }
    if (toIndex > arrayLength) {
      throw new ArrayIndexOutOfBoundsException.ArrayIndexOutOfBoundsException(toIndex);
    }
  }
  static asList(...args) {
    return args;
  ...
  static copyOfRange(original, from, to) {
    ...
    ZXingSystem.ZXingSystem.arraycopy(original, from, copy, 0, newLength);
    return copy;
  }
  /*
  ...
  */
  static binarySearch(ar, el, comparator) {
    if (void 0 === comparator) {
      comparator = ZXingArrays.numberComparator;
    }
    let m = 0;
    let n = ar.length - 1;
    while (m <= n) {
...
exports.ZXingArrays = ZXingArrays;
//# sourceMappingURL=ZXingArrays.cjs.map
//# sourceMappingURL=ZXingArrays.cjs.map