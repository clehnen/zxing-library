...
class ZXingStringBuilder {
  ...
  append(s) {
    if (typeof s === "string") {
      ...
      this.value += StringUtils.StringUtils.castAsNonUtf8Char(s, this.encoding);
    } else {
...
exports.ZXingStringBuilder = ZXingStringBuilder;
//# sourceMappingURL=StringBuilder.cjs.map
//# sourceMappingURL=StringBuilder.cjs.map