  ...
  static getDataMaskBit(maskPattern, x, y) {
    ...
    switch (maskPattern) {
      ...
      case 7:
        ...
        break;
      default:
        throw new IllegalArgumentException.IllegalArgumentException("Invalid mask pattern: " + maskPattern);
    }
...
exports.QRCodeMaskUtil = QRCodeMaskUtil;
//# sourceMappingURL=QRCodeMaskUtil.cjs.map
//# sourceMappingURL=QRCodeMaskUtil.cjs.map