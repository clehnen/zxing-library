...
declare class QRCodeEncoder {
     ...
     *   or configuration
     */
    static encode(content: string, ecLevel: QRCodeDecoderErrorCorrectionLevel, hints?: Map<EncodeHintType, any>): QRCodeEncoderQRCode;
    /**
     ...
     */
    static chooseMode(content: string, encoding?: string): QRCodeMode;
     ...
     */
    static appendModeInfo(mode: QRCodeMode, bits: BitArray): void;
    /**
     * Append length info. On success, store the result in "bits".
     */
    static appendLengthInfo(numLetters: number, version: QRCodeVersion, mode: QRCodeMode, bits: BitArray): void;
    /**
     * Append "bytes" in "mode" mode (encoding) into "bits". On success, store the result in "bits".
     */
    static appendBytes(content: string, mode: QRCodeMode, bits: BitArray, encoding: string): void;
