...
var QRCodeDecodedBitStreamParser = require('./QRCodeDecodedBitStreamParser');
var QRCodeDecoderMetaData = require('./QRCodeDecoderMetaData');
...
class Decoder {
  ...
  decodeBooleanArray(image, hints) {
    return this.decodeBitMatrix(BitMatrix.BitMatrix.parseFromBooleanArray(image), hints);
  }
  ...
  decodeBitMatrix(bits, hints) {
    ...
    try {
      ...
      result.setOther(new QRCodeDecoderMetaData.QRCodeDecoderMetaData(true));
      return result;
    } catch (e) {
      if (ex !== null) {
        throw ex;
  ...
  decodeBitMatrixParser(parser, hints) {
    ...
    return QRCodeDecodedBitStreamParser.QRCodeDecodedBitStreamParser.decode(resultBytes, version, ecLevel, hints);
  }
  /**
