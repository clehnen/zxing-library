...
var QRCodeVersion = require('./QRCodeVersion');
var QRCodeDecoderFormatInformation = require('./QRCodeDecoderFormatInformation');
var QRCodeDataMask = require('./QRCodeDataMask');
...
class BitMatrixParser {
  ...
  readFormatInformation() {
    ...
    this.parsedFormatInfo = QRCodeDecoderFormatInformation.QRCodeDecoderFormatInformation.decodeFormatInformation(formatInfoBits1, formatInfoBits2);
  ...
  readVersion() {
    ...
    if (provisionalVersion <= 6) {
      return QRCodeVersion.QRCodeVersion.getVersionForNumber(provisionalVersion);
    }
    let versionBits = 0;
    ...
    let theParsedVersion = QRCodeVersion.QRCodeVersion.decodeVersionInformation(versionBits);
    ...
    theParsedVersion = QRCodeVersion.QRCodeVersion.decodeVersionInformation(versionBits);
    if (theParsedVersion !== null && theParsedVersion.getDimensionForVersion() === dimension) {
      this.parsedVersion = theParsedVersion;
      return theParsedVersion;
    }
  ...
  readCodewords() {
    ...
    const dataMask = QRCodeDataMask.QRCodeDataMask.values.get(formatInfo.getDataMask());
    const dimension = this.bitMatrix.getHeight();
  ...
  remask() {
    ...
    const dataMask = QRCodeDataMask.QRCodeDataMask.values.get(this.parsedFormatInfo.getDataMask());
    const dimension = this.bitMatrix.getHeight();
    dataMask.unmaskBitMatrix(this.bitMatrix, dimension);
  }
  /**
...
//# sourceMappingURL=BitMatrixParser.cjs.map
//# sourceMappingURL=BitMatrixParser.cjs.map