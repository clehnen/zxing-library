...
var QRCodeDecoderErrorCorrectionLevel = require('./QRCodeDecoderErrorCorrectionLevel');
...
class QRCodeDecoderFormatInformation {
  ...
  constructor(formatInfo) {
    this.errorCorrectionLevel = QRCodeDecoderErrorCorrectionLevel.QRCodeDecoderErrorCorrectionLevel.forBits(formatInfo >> 3 & 3);
    this.dataMask = /*(byte) */
    formatInfo & 7;
  }
  static numBitsDiffering(a, b) {
    return ZXingInteger.ZXingInteger.bitCount(a ^ b);
  }
  /**
...
exports.QRCodeDecoderFormatInformation = QRCodeDecoderFormatInformation;
//# sourceMappingURL=QRCodeDecoderFormatInformation.cjs.map
//# sourceMappingURL=QRCodeDecoderFormatInformation.cjs.map