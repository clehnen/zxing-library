...
var AlignmentPattern = require('./AlignmentPattern');
...
class AlignmentPatternFinder {
  ...
  handlePossibleCenter(stateCount, i, j) {
    ...
    if (!isNaN(centerI)) {
      ...
      const point = new AlignmentPattern.AlignmentPattern(centerJ, centerI, estimatedModuleSize);
...
//# sourceMappingURL=AlignmentPatternFinder.cjs.map
//# sourceMappingURL=AlignmentPatternFinder.cjs.map