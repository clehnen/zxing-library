import { ZXingCharset } from '../../util/ZXingCharset.cjs';
import { char } from '../../../customTypings.cjs';
import { SymbolShapeHint } from './constants.cjs';
import { MinimalECIInput } from '../../common/MinimalECIInput.cjs';
...
declare class MinimalEncoder {
     ...
     */
    static encodeHighLevel(msg: string, priorityCharset?: ZXingCharset, fnc1?: number, shape?: SymbolShapeHint): string;
    /**
     ...
     */
    static encode(input: string, priorityCharset: ZXingCharset, fnc1: number, shape: SymbolShapeHint, macroId: number): Uint8Array;
...
declare class Input extends MinimalECIInput {
    ...
    constructor(stringToEncode: string, priorityCharset: ZXingCharset, fnc1: number, shape: SymbolShapeHint, macroId: number);
    getMacroId(): number;
