...
class DataMatrixDefaultPlacement {
  /**
   * Main constructor
   *
  ...
  constructor(codewords, numcols, numrows) {
    ...
    ZXingArrays.ZXingArrays.fill(this.bits, 2);
  }
  codewords;
  numcols;
  numrows;
...
exports.DataMatrixDefaultPlacement = DataMatrixDefaultPlacement;
//# sourceMappingURL=DataMatrixDefaultPlacement.cjs.map
//# sourceMappingURL=DataMatrixDefaultPlacement.cjs.map