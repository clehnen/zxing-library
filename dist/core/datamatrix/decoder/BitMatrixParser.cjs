...
class BitMatrixParser {
  ...
  constructor(bitMatrix) {
    ...
    this.readMappingMatrix = new BitMatrix.BitMatrix(this.mappingBitMatrix.getWidth(), this.mappingBitMatrix.getHeight());
  }
  getVersion() {
    return this.version;
  }
  ...
  static readVersion(bitMatrix) {
    ...
    return Version.Version.getVersionForDimensions(numRows, numColumns);
  }
  /**
  ...
  extractDataRegion(bitMatrix) {
    ...
    if (bitMatrix.getHeight() !== symbolSizeRows) {
      throw new IllegalArgumentException.IllegalArgumentException("Dimension of bitMatrix must match the version size");
    }
    ...
    const bitMatrixWithoutAlignment = new BitMatrix.BitMatrix(sizeDataRegionColumn, sizeDataRegionRow);
