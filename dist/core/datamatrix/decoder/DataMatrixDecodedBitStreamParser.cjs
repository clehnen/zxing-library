...
class DataMatrixDecodedBitStreamParser {
  ...
  static decode(bytes) {
    ...
    const resultTrailer = new StringBuilder.ZXingStringBuilder();
    ...
    return new DecoderResult.DecoderResult(bytes, result.toString(), byteSegments.length === 0 ? null : byteSegments, null);
  }
  /**
  ...
  static decodeBase256Segment(bits, result, byteSegments) {
    ...
    try {
      result.append(ZXingStringEncoding.ZXingStringEncoding.decode(bytes, StringUtils.StringUtils.ISO88591));
    } catch (uee) {
      throw new IllegalStateException.IllegalStateException("Platform does not support required encoding: " + uee.message);
    }
  }
  /**
...
exports.DataMatrixDecodedBitStreamParser = DataMatrixDecodedBitStreamParser;
//# sourceMappingURL=DataMatrixDecodedBitStreamParser.cjs.map
//# sourceMappingURL=DataMatrixDecodedBitStreamParser.cjs.map