 ...
 * @author Sean Owen
 */
export class DataMatrixDecodedBitStreamParser {
  ...
  private static TEXT_SHIFT2_SET_CHARS = DataMatrixDecodedBitStreamParser.C40_SHIFT2_SET_CHARS;
  ...
  private static decodeAsciiSegment(bits: BitSource,
                                         ...
                                         resultTrailer: ZXingStringBuilder): Mode {
   ...
   */
  private static decodeC40Segment(bits: BitSource, result: ZXingStringBuilder): void {
   ...
   */
  private static decodeTextSegment(bits: BitSource, result: ZXingStringBuilder): void {
   ...
   */
  private static decodeEdifactSegment(bits: BitSource, result: ZXingStringBuilder): void {
    do {
