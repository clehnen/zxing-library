...
export class QRCodeEncoder {
    ...
    private static calculateMaskPenalty(matrix: QRCodeByteMatrix): number /*int*/ {
        return QRCodeMaskUtil.applyMaskPenaltyRule1(matrix)
    ...
    public static encode(content: string,
        ...
        hints: Map<EncodeHintType, any> = null): QRCodeEncoderQRCode /*throws WriterException*/ {

        // Determine what character encoding has been specified by the caller, if any
        let encoding: string = QRCodeEncoder.DEFAULT_BYTE_MODE_ENCODING;
        ...
        const mode: QRCodeMode = this.chooseMode(content, encoding);
     ...
     */
    private static recommendVersion(ecLevel: QRCodeDecoderErrorCorrectionLevel,
        mode: QRCodeMode,
        headerBits: BitArray,
        dataBits: BitArray): QRCodeVersion /*throws WriterException*/ {
    ...
    private static calculateBitsNeeded(mode: QRCodeMode,
        headerBits: BitArray,
        dataBits: BitArray,
        version: QRCodeVersion): number /*int*/ {
     ...
     */
    public static chooseMode(content: string, encoding: string = null): QRCodeMode {
    ...
    private static isOnlyDoubleByteKanji(content: string): boolean {
        ...
        try {
            bytes = ZXingStringEncoding.encode(content, CharacterSetECI.SJIS); // content.getBytes("Shift_JIS"))
    ...
    private static chooseMaskPattern(bits: BitArray,
        ...
        matrix: QRCodeByteMatrix): number /*int*/ /*throws WriterException*/ {
    ...
    private static chooseVersion(numInputBits: number /*int*/, ecLevel: QRCodeDecoderErrorCorrectionLevel): QRCodeVersion /*throws WriterException*/ {
     ...
     */
    private static willFit(numInputBits: number /*int*/, version: QRCodeVersion, ecLevel: QRCodeDecoderErrorCorrectionLevel): boolean {
    ...
    public static interleaveWithECBytes(bits: BitArray,
        ...
        for (let i = 0; i < numRSBlocks; ++i) {
            ...
            const ecBytes: Uint8Array = QRCodeEncoder.generateECBytes(dataBytes, numEcBytesInBlock[0]);
     ...
     */
    public static appendModeInfo(mode: QRCodeMode, bits: BitArray): void {
     ...
     */
    public static appendLengthInfo(numLetters: number /*int*/, version: QRCodeVersion, mode: QRCodeMode, bits: BitArray): void /*throws WriterException*/ {
