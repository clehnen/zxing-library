...
export class QRCodeMaskUtil {
     ...
     */
    public static applyMaskPenaltyRule1(matrix: QRCodeByteMatrix): number /*int*/ {
     ...
     */
    public static applyMaskPenaltyRule2(matrix: QRCodeByteMatrix): number /*int*/ {
        let penalty = 0;
     ...
     */
    public static applyMaskPenaltyRule3(matrix: QRCodeByteMatrix): number /*int*/ {
        let numPenalties = 0;
        const array: Array<Uint8Array> = matrix.getArray();
        const width: number /*int*/ = matrix.getWidth();
        const height: number /*int*/ = matrix.getHeight();
        for (let y = 0; y < height; y++) {
            for (let x = 0; x < width; x++) {
                ...
                if (x + 6 < width &&
                    ...
                    arrayY[x + 5] === 0 &&
                    arrayY[x + 6] === 1 &&
                    (QRCodeMaskUtil.isWhiteHorizontal(arrayY, x - 4, x) || QRCodeMaskUtil.isWhiteHorizontal(arrayY, x + 7, x + 11))) {
                    numPenalties++;
                }
                if (y + 6 < height &&
                    array[y][x] === 1 &&
                    ...
                    array[y + 5][x] === 0 &&
                    array[y + 6][x] === 1 &&
                    (QRCodeMaskUtil.isWhiteVertical(array, x, y - 4, y) || QRCodeMaskUtil.isWhiteVertical(array, x, y + 7, y + 11))) {
                    numPenalties++;
                }
            }
        }
     ...
     */
    public static applyMaskPenaltyRule4(matrix: QRCodeByteMatrix): number /*int*/ {
        let numDarkCells = 0;
        const array: Array<Uint8Array> = matrix.getArray();
        const width: number /*int*/ = matrix.getWidth();
        const height: number /*int*/ = matrix.getHeight();
     ...
     */
    private static applyMaskPenaltyRule1Internal(matrix: QRCodeByteMatrix, isHorizontal: boolean): number /*int*/ {
        let penalty = 0;
