 ...
 * @author Sean Owen
 * @see DataMask
 * @see QRCodeDecoderErrorCorrectionLevel
 */
export class QRCodeDecoderFormatInformation {
    ...
    private errorCorrectionLevel: QRCodeDecoderErrorCorrectionLevel;
    private dataMask: number; /*byte*/

    private constructor(formatInfo: number /*int*/) {
        // Bits 3,4
        this.errorCorrectionLevel = QRCodeDecoderErrorCorrectionLevel.forBits((formatInfo >> 3) & 0x03);
        // Bottom 3 bits
     ...
     */
    public static decodeFormatInformation(maskedFormatInfo1: number /*int*/, maskedFormatInfo2: number /*int*/): QRCodeDecoderFormatInformation {
        ...
        // first
        return QRCodeDecoderFormatInformation.doDecodeFormatInformation(maskedFormatInfo1 ^ QRCodeDecoderFormatInformation.FORMAT_INFO_MASK_QR,
            maskedFormatInfo2 ^ QRCodeDecoderFormatInformation.FORMAT_INFO_MASK_QR);
    }

    private static doDecodeFormatInformation(maskedFormatInfo1: number /*int*/, maskedFormatInfo2: number /*int*/): QRCodeDecoderFormatInformation {
    ...
    public getErrorCorrectionLevel(): QRCodeDecoderErrorCorrectionLevel {
    ...
    public equals(o: Object): boolean {
        ...
        const other = <QRCodeDecoderFormatInformation>o;
